...
def _rotation_from_env(env_name: str, default: Cv2Rotation) -> Cv2Rotation:
...
def lekiwi_cameras_config() -> dict[str, CameraConfig]:
    return {
        "front": OpenCVCameraConfig(
            ...
            width=640,
            height=480,
            rotation=_rotation_from_env("LEROBOT_LEKIWI_FRONT_ROTATION", Cv2Rotation.ROTATE_180),
        ),
        "wrist": OpenCVCameraConfig(
            ...
            width=480,
            height=640,
            rotation=_rotation_from_env("LEROBOT_LEKIWI_WRIST_ROTATION", Cv2Rotation.ROTATE_90),
        ),
    }
