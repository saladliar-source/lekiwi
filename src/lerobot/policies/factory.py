...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    """
    # During finetuning from a pretrained policy on a new robot/dataset, we still
    # need fresh processors built from the current dataset stats. Loading the
    # pretrained processors would reuse the source robot's normalization stats,
    # which can make losses explode when action/state scales differ. When
    # `dataset_stats` is absent (e.g. evaluation or resume), load saved processors.
